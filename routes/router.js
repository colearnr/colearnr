...
module.exports = function(app) {
  ...
  if (config.enable_search_robots) {
    app.get('/sitemap.xml', function(req, res) {
      sitemaplib.getAllUrls(function(sitemapurls) {
  ...
  // Singly authentication callback
  // Redirect back to the page requested.
  app.get('/auth/callback', pageOptionsSetter, sessionOptionsSetter, passlib.passport.authenticate('singly', {
