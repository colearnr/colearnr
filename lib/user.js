var db = require("../common/db"),
  ...
  WELCOME_TPL = __dirname + "/../email/templates/welcome.html",
  INVITE_TPL = __dirname + "/../email/templates/invite.html",
  INVITE_COLLAB_TPL = __dirname + "/../email/templates/invite_collab.html",
  INVITE_COLEARNR_TPL = __dirname + "/../email/templates/invite_colearnr.html",
  PASSWORD_RESET_TPL = __dirname + "/../email/templates/password_reset.html",
...
var user = {
  ...
  isComplete: function(userObj) {
    var ret = false;
    //console.log(userObj);
    if (userObj && userObj.emails && userObj.name && !userObj.temporary_password
      && userObj.agree_terms && userObj.agree_terms == "agreed") {
      ret = true;
    }
