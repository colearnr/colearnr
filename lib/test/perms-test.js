...
var suite = vows.describe('perms test suite');
var mockuser = {
    _id: '123',
    name: 'test-user',
...
perms.addFreeTopicRolePerms(mocktopic, function(err) {});
perms.addFreeTopicRolePerms(mockdrafttopic, function(err) {});
perms.addFreeTopicRolePerms(mocktopicwkey, function(err) {});
perms.addFreeTopicRolePerms(srctopic, function(err) {});
perms.addFreeTopicRolePerms(desttopic, function(err) {});
