...
const suite = vows.describe('perms test suite')
const mockuser = {
  _id: '123',
  name: 'test-user',
...
const mocktopicWithCollaborator = {
  _id: '456',
  name: 'test-topic',
  path: null,
  template: 'category',
...
suite.addBatch({
  ...
  .addBatch({
    ...
    'check if the free user has deconste permission': {
      topic: function () { perms.isUserAllowed(mockuser, mocktopic, 'deconste', this.callback) },
      'checks': function (err, res) {
        should.not.exist(err)
        res.should.be.false
      }
  ...
  .addBatch({
    ...
    'Check if the free user is now able to do all the 4 operations': {
      ...
      'checks': function (err, permlist) {
        ...
        permlist[mocktopic._id].should.containEql('view').containEql('add')
          .containEql('edit').containEql('deconste')
      }
    },
    ...
    'check if the user has deconste permission': {
      topic: function () { perms.isUserAllowed(mockuser, mocktopic, 'deconste', this.callback) },
      'checks': function (err, res) {
        should.not.exist(err)
        res.should.be.true
    ...
    'check if the user has deconste permission based on role': {
      topic: function () { perms.isRoleAllowed(mockuser, mocktopic, 'deconste', this.callback) },
      'checks': function (err, res) {
        should.not.exist(err)
        res.should.be.true
      }
  ...
  .addBatch({
    ...
    'check if the user has deconste permission based on roles': {
      topic: function () { perms.isRoleAllowed(mockuser, mocktopic, 'deconste', this.callback) },
      'checks': function (err, res) {
        should.not.exist(err)
        res.should.be.false
  ...
  .addBatch({
    'Check if mockuser can deconste schedtopic': {
      topic: function () { perms.isUserAllowed(mockuser, schedtopic, 'deconste', this.callback) },
      'check': function (err, res) {
        should.not.exist(err)
        res.should.be.false
      }
    },
    'Check if mockuser can deconste schedtopic2': {
      topic: function () { perms.isUserAllowed(mockuser, schedtopicwcolearnr, 'deconste', this.callback) },
      'check': function (err, res) {
        should.not.exist(err)
        res.should.be.false
      }
    },
    'Check if mockuser2 can deconste schedtopic': {
      topic: function () { perms.isUserAllowed(mockuser2, schedtopic, 'deconste', this.callback) },
      'check': function (err, res) {
        should.not.exist(err)
        res.should.be.false
      }
    },
    'Check if mockuser2 can deconste schedtopicwcolearnr': {
      topic: function () { perms.isUserAllowed(mockuser2, schedtopicwcolearnr, 'deconste', this.callback) },
      'check': function (err, res) {
        should.not.exist(err)
        res.should.be.false
      }
    },
    'Check if mockuser2 can deconste schedtopicAscolearnr': {
      topic: function () { perms.isUserAllowed(mockuser2, schedtopicAscolearnr, 'deconste', this.callback) },
      'check': function (err, res) {
        should.not.exist(err)
        res.should.be.false
      }
    },
    'Check if mockuser2 can deconste schedtopicOwnTopic': {
      topic: function () { perms.isUserAllowed(mockuser2, schedtopicOwnTopic, 'deconste', this.callback) },
      'check': function (err, res) {
        should.not.exist(err)
        res.should.be.true
      }
    },
    'Check if mockuser2 can deconste pschedtopic': {
      topic: function () { perms.isUserAllowed(mockuser2, pschedtopic, 'deconste', this.callback) },
      'check': function (err, res) {
        should.not.exist(err)
        res.should.be.false
      }
    },
    'Check if mockuser2 can deconste pschedtopicwcolearnr': {
      topic: function () { perms.isUserAllowed(mockuser2, pschedtopicwcolearnr, 'deconste', this.callback) },
      'check': function (err, res) {
        should.not.exist(err)
        res.should.be.false
      }
    },
    'Check if mockuser2 can deconste pschedtopicAscolearnr': {
      topic: function () { perms.isUserAllowed(mockuser2, pschedtopicAscolearnr, 'deconste', this.callback) },
      'check': function (err, res) {
        should.not.exist(err)
        res.should.be.false
      }
    },
    'Check if mockuser2 can deconste pschedtopicOwnTopic': {
      topic: function () { perms.isUserAllowed(mockuser2, pschedtopicOwnTopic, 'deconste', this.callback) },
      'check': function (err, res) {
        should.not.exist(err)
        res.should.be.true
      }
  ...
  .addBatch({
    'Check if mockuser can deconste nschedtopic': {
      topic: function () { perms.isUserAllowed(mockuser, nschedtopic, 'deconste', this.callback) },
      'check': function (err, res) {
        should.not.exist(err)
        res.should.be.false
      }
    },
    'Check if mockuser can deconste nschedtopic2': {
      topic: function () { perms.isUserAllowed(mockuser, nschedtopicwcolearnr, 'deconste', this.callback) },
      'check': function (err, res) {
        should.not.exist(err)
        res.should.be.false
      }
    },
    'Check if mockuser2 can deconste nschedtopic': {
      topic: function () { perms.isUserAllowed(mockuser2, nschedtopic, 'deconste', this.callback) },
      'check': function (err, res) {
        should.not.exist(err)
        res.should.be.false
      }
    },
    'Check if mockuser2 can deconste nschedtopicwcolearnr': {
      topic: function () { perms.isUserAllowed(mockuser2, nschedtopicwcolearnr, 'deconste', this.callback) },
      'check': function (err, res) {
        should.not.exist(err)
        res.should.be.false
      }
    },
    'Check if mockuser2 can deconste nschedtopicAscolearnr': {
      topic: function () { perms.isUserAllowed(mockuser2, nschedtopicAscolearnr, 'deconste', this.callback) },
      'check': function (err, res) {
        should.not.exist(err)
        res.should.be.false
      }
    },
    'Check if mockuser2 can deconste nschedtopicOwnTopic': {
      topic: function () { perms.isUserAllowed(mockuser2, nschedtopicOwnTopic, 'deconste', this.callback) },
      'check': function (err, res) {
        should.not.exist(err)
        res.should.be.true
      }
