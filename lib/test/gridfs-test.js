...
var TEST_DOC = path.resolve(__dirname, 'sample.docx')
// var TEST_PPT = path.resolve(__dirname, 'sample.pptx')
// var TEST_XLS = path.resolve(__dirname, 'sample.xlsx')

var suite = vows.describe('GridFS test suite')
suite.addBatch({
