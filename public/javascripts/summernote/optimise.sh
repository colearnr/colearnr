...
cat summernote-ext-embed.min.js summernote-ext-notes.min.js summernote-ext-video.min.js summernote-ext-emojione.min.js summernote-ext-emoji.min.js > summernote-ext.min.js
