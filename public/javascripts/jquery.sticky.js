(function ($){
  $.fn.sticky_div = function (options) {
    ...
    $("<style type='text/css'> .sticky-div{ position:fixed !important; top:" + options.top + "px !important; z-index: 999;" + (options.width ? ("width: " + options.width + ";") : "") + (options.custom_css) + "} </style>").appendTo("head");
