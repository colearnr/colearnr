var vows = require('vows'),
    ...
    topicMapUtil = require('../util/topicMapUtil');

var categoryMapSimple = {
    title: 'First topic',
    id: 10,
    order: null,
    formatVersion: 2,
...
var expectedListMixed = [ { uiKey: '10',
      name: 'First topic',
      id: 'first-topic',
      oid: '52c6663a0b7b13b309000002',
      order: null,
