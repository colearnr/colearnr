...
vows.describe('util').addBatch({
  'When using the util module': {
    ...
    'empty checks': {
      topic: function () {
        let ret = []
        ;[null, undefined, '', {}, [], ' ', 'Hello world', new Date(), function () {}].forEach(function (v) {
    ...
    'convert links test': {
      topic: function () {
        let ret = []
        ;[[{'_id': '521e717d26fffac0350a3f3a'}], [{'_id': '521e717d26fffac0350a3f3a'}, {'path': ',mathematics,abstract-algebra,'}], [{'path': ',mathematics,abstract-algebra,'}], [{'_id': '521e717d26fffac0350a3f3a'}, {'_id': '51eee8d4c9c2700a05000003'}], [{'path': ',mathematics,abstract-algebra,'}, {'path': ',entrepreneurship,centre-for-entrepreneurial-learning,'}]].forEach(function (v) {
